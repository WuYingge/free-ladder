...
# ====================================================================
GROUPS: list[tuple] = [
    (f"c2_{RANK_FILTERS_60_120[i]}", c2_factor, (), (RANK_FILTERS_60_120[i], ), ) for i in range(len(RANK_FILTERS_60_120))
...
# 执行参数
# ====================================================================
OUTPUT_BASE_DIR: str = "/mnt/c/Users/wyg/Documents/invest/backtest/c2_vol_trank_filter"
BASENAME_TAG: str = "c2_vol_trank_filter"
TITLE: str = "宽动量基线回测 — c2_vol_trank_filter 分组变换"
