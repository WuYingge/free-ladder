...
GROUPS: list[tuple] = [
    ...
    (f"c2_rank_filter_120_b03_a01", c2_cond, (), (RankFilter(vol120, 0.3, 0.1),),),
    (f"c2_rank_filter_120_b03_a0", c2_cond, (), (RankFilter(vol120, 0.3, 0),),),
...
# 执行参数
# ====================================================================
OUTPUT_BASE_DIR: str = "/mnt/c/Users/wyg/Documents/invest/backtest/c2_vol_rank_filter_止损测试"
BASENAME_TAG: str = "c2_vol_rank_filter_止损测试"
TITLE: str = "宽动量基线回测 — c2_vol_rank_filter_止损测试"
